...
class AudioInputManager:
    ...
    def _setup_fallback_devices(self):
        ...
        self.input_devices = [
            {"index": 0, "name": "Simulated Microphone (Test Mode)", "channels": 1, "sample_rate": 16000, "type": "simulated"},
            {"index": 1, "name": "Demo Audio Generator", "channels": 1, "sample_rate": 16000, "type": "simulated"},
        ]
        self.current_device = self.input_devices[0]
        self.hardware_available = False
